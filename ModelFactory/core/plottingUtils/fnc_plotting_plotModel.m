...
function fnc_plotting_plotModel (model, plotJoints, plotPoints, plotComs,...
    plotMarkers, printLabels, fAlpha, markerSize, rootDisplacement, markerColor)
    ...
    if ~isempty(model{rootSegmentID}.points)
        ...
        for pointNo = 1:numPoints
            ...
            plot3(global_position(1), global_position(2),...
                global_position(3), 'o', 'markersize', markerSize,...
    ...
    if plotPoints == 1
        if ~isempty(model{segmentID}.points)
            ...
            for pointNo = 1:numPoints
                ...
                plot3(global_position(1), global_position(2), global_position(3), 'o', 'markersize', markerSize, 'markerfacecolor', markerColor);
                if printLabels == 1
